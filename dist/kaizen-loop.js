...
async function writeResultFile(resultDirectory, resultPath, contents) {
    ...
    try {
        const file = await open(temporaryResultPath, constants.O_CREAT | constants.O_EXCL | constants.O_WRONLY | constants.O_NOFOLLOW, 0o666);
